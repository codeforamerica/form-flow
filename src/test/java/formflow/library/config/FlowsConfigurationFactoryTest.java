...
public class FlowsConfigurationFactoryTest {
    ...
    public void testValidateLandmarksAfterSubmitPages_ThrowsExceptionWhenLandmarksMissing() {
        ...
        FlowConfigurationException errorThrownForNoLandmarkSectionAtAll = assertThrows(FlowConfigurationException.class,
                () -> flowsConfigurationFactory.validateLandmarksAfterSubmitPages(flowConfig));
        ...
        FlowConfigurationException errorThrownForNoAfterSubmitLandmark = assertThrows(FlowConfigurationException.class,
                () -> flowsConfigurationFactory.validateLandmarksAfterSubmitPages(flowConfig));
        ...
        flowConfig.setLandmarks(landmarks);
        FlowConfigurationException errorThrownForEmptyAfterSubmitLandmark = assertThrows(FlowConfigurationException.class,
                () -> flowsConfigurationFactory.validateLandmarksAfterSubmitPages(flowConfig));
