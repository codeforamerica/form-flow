...
public class InputsTest extends AbstractMockMvcTest {
    ...
    void shouldOnlyRunValidationIfItHasARequiredAnnotation() throws Exception {
        ...
        postExpectingFailureAndAssertErrorDisplaysForThatInput("testFlow", "pageWithOptionalValidation",
    ...
    void shouldShowMultipleErrorMessagesOnSingleInput() throws Exception {
        postExpectingFailureAndAssertErrorsDisplaysForThatInput("testFlow", "pageWithMultipleValidationInput",
                "inputWithMultipleValidations", "",
                2);
        postExpectingFailureAndAssertErrorsDisplayForThatInput("testFlow", "pageWithMultipleValidationInput",
                "inputWithMultipleValidations", "",
    ...
    void shouldCrossValidateDateInput() throws Exception {
        ...
        assertThat(screen.getInputErrorMessages("dateFull")).containsExactly(
                "Make sure you enter a date between 01/01/1901 and now");
    }
    ...
    public class Address {
        ...
        public class AddressValidationSuccess {
            ...
            void updatesSuggestionWhenGoingBackAndUpdatingNewAddress() throws Exception {
                ...
                assertThat(nextScreen.getTitle()).isEqualTo("Validation Is On");
                assertThat(nextScreen.getElementTextById("validated-address-label")).contains(
                        "123 Other Main Street Apt BValidated");
