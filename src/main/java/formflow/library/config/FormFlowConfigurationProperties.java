...
/**
 * Configuration properties for managing form flows within the application. This class provides configurations for many form flow
 * features. It is configured using properties prefixed with 'form-flow'.
 */
@Configuration
...
public class FormFlowConfigurationProperties {
  ...
  /**
   * Checks if the Submission for the flow with flowName should be locked, preventing further updates after it has been
   * submitted.
   *
   * @param flowName the name of the flow to check.
